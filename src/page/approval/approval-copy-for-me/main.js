...
const ApplySearchItem = [
    ...
    {id: 5, label: '状态', fieldName: 'state', optionArr: StateArr, initialValue: undefined, type: 'select'},
];
...
class Main extends React.Component {
    ...
    _tableColumns = [
        ...
        },
        {
            ...
            render: (text, record) => {
                ...
                return (
                    <span key={`${id}_edit`}>
                        <a onClick={() => this._editAndCheck(OperateType, id, title)}>
                            查看
                        </a>
                    </span>
                )
    ...
    _getTableData = (pageIndex, queryObject = this.state.formQueryObject) => {
        ...
        request(api.copyForMe, params, 'post', session.get('token'))
            .then(res => {
                console.log('res', res);
                if (res.success) {
    ...
    _editAndCheck = (operateType, id, title) => {
        const url = api.detailInfoById;
        this._editAndCheckInfo({url, operateType, title, instId: id});
    };
    ...
    render() {
        ...
        const {
            ...
            auditTaskId, auditNodeId, auditNodeType, approvalState,
        } = this.state;
        return (
                ...
                <div className='main-page'>
                    <div className='title-view'>
                        <Row type='flex' justify='space-between' align='middle'>
                            <Col>
                                <MyTitle title='抄送我的' imgSrc={ass.img.titleIcon}/>
                            </Col>
                        </Row>
                    </div>
