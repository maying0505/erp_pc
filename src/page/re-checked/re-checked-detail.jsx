...
import SubscriptionInfo from 'component/subscription-info'
import ReCheckedOpinion from './re-checked-opinion.jsx'
...
class ReCheckedDetail extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            disabled: false,
    ...
    render() {
        ...
        return (
            <Card bordered={false}>
                ...
                <div className="position-r">
                    <Tabs defaultActiveKey="1">
                        ...
                        <TabPane tab="签约信息" key="3">
                            <SubscriptionInfo pictureDataJson={this.state.pictureDataJson}/>
                        </TabPane>
                ...
                <PriBorrInfoShow ifExtension={this.state.ifExtension}
...
export default ReCheckedDetail
