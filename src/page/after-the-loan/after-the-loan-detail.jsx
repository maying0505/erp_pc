        ...
        columns: [
            ...
            },
            {
                ...
                render: (record) => record.state === '1' ?
                    <span className="green-span" onClick={this.addCollectionRecords.bind(this, record)}>添加记录</span> :
                    <span>--</span>
            },
        ],
    };
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="white-title white-title-small marginT20"><p className="title-small">记录</p><Divider/>
                </div>
                ...
                >
                    <Form onSubmit={this.handleOk} layout="inline" className="ant-form-my">
                        ...
                        <div>
                            <div className="blod-title">描述</div>
...
class AfterTheLoanDetail extends React.Component {
    static propTypes = {};
    ...
    getCustomer = () => {
        request(`${api.customerByGet}${this.props.params.id}`, {}, 'get', session.get('token')) //借款人信息详情
            .then(res => {
                console.log(JSON.stringify(res))
                if (res.success) {
                    this.setState({
    ...
    getProductInfo = () => {
        request(`${api.productByGet}${this.props.params.productId}`, {}, 'get', session.get('token')) //借款人信息详情
            .then(res => {
                console.log(JSON.stringify(res))
                this.setState({loading: false})
                if (res.success) {
    ...
    render() {
        return (
            <Card bordered={false}>
                <h1 className="detail-title">详情页</h1>
                <Divider/>
                <Spin spinning={this.state.loading} size="large">
                    <div style={{backgroundColor: '#fff', width: '100%'}}>
                        ...
                        <h2 className="text-left green-title">还款详情及记录</h2>
                        <div className="white-title white-title-small marginT20"><p className="title-small">还款详情</p>
                            <Divider/></div>
                        <PaymentDetails productId={this.props.params.productId}/>
                        <div className="gray-bettw"></div>
...
export default AfterTheLoanDetail
