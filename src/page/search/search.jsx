...
class SearchForm extends React.Component {
                  ...
                  this.setState({
                    columns: [
                      ...
                      },
                      {
                        ...
                        render: (text,record) =><span className="green-span"  onClick={this.viewDetail.bind(this,record)}>查看</span>
                      },
                    ]
                  })
                });
    ...
    handleExport = () =>{//导出
      request(api.caseListExport,{...this.state.pageInfo,...this.state.searchInfo},'post',session.get('token'),30*1000)
      .then(res => {
          console.log(JSON.stringify(res))
          if (res.success){
